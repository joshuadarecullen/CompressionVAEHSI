from typing import Any, Dict, Optional, Tuple, AnyStr
...
class BigEarthNetHubDataset(Dataset):
    ...
    @property
    def tensor_info(self) -> Dict[str, Dict[str, Any]]:
...
class BigEarthNetDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        dataset_name: str,
        batch_size: int,
        train_val_test_split: Tuple[int, int, int] = (None, None, None),
        num_workers: int = 0,
        ...
        self.train_dataset, self.valid_dataset, self.test_dataset = train_val_test_split
        self.transforms = transforms
